...
const renderSeats = (row, count = 9)=>(
  ...
  return show ? (
    <div className='flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50'>
      {/* Available timings */}
      <div className='w-60 bg-primary/10 border border-primary/20 rounded-lg py-10 h-max md:sticky md:top-28 mt-44'>
      ...
      {/* seat layout */}
      <div className='relative flex-1 flex flex-col items-center max-md:mt-16 mt-44'>
